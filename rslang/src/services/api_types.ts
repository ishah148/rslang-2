...
export type responceAuth = {
  status: number | string
  body: AxiosResponse<Auth> | AxiosResponse<AuthError>
}
...
// =============== EXAMPLES ===============
const restLoginExample = {
  message: "Authenticated",
  token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYzM…zQwfQ.RFkJHKe2qD55ToKwigw2x0h5hqVaUc_EzC8y2ggNaII",
  refreshToken: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYzM…U0MH0.gDvsKHv30YpEKog5FTt7v_J9WcJv8aeLXV5s5RZsXOM",
  userId: "6303e7d46dd23500166f5e1a",
  name: "ugyk8fxi5ol",
}

export const testUser = { email: "qweqweqwe@mail.ru", password: "qweqweqwe" }
export const testUserErr = { email: "qweqweqwe@mail.ru", password: "" }

export const newWordTest = {
